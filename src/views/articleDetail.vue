  ...
  <div class="articleDetail-container">
    <div class="header-section">
      <div class="header-content">
        <el-image :src="iconUrl" alt="like" class="like-icon"  style="width: 60px; height: 60px;"/>
        <h1>知识文章详情</h1>
      </div>
    </div>
    <div class="content">
      <div class="diary-card">
        ...
        <div class="sub-title">
          <el-tag  class="category-tag" plain size="large">{{articleDetail.categoryName}}</el-tag>
          <div class="flex-box">
      ...
      <div class="diary-card">
        ...
        <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length > 0">
          ...
          <div class="tags-list">
            <el-tag v-for="tag in articleDetail.tagArray" :key="tag" type="info" effect="light" plain size="large">{{tag}}</el-tag>
          </div>
        </div>
      </div>
    </div>
