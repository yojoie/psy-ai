  ...
  <div class="home-container">
    <div class="content">
      <div class="text">
        ...
        <p class="descrption">每个深夜，每个焦虑的时刻，我们都在这里。不必独自承受，让心与心的连接温暖您的每一天</p>
      ...
      <div class="robot">
        <el-image style="width: 150px;height: 150px;" :src="iconUrl" class=""/>
      </div>
    </div>
  </div>
...
.home-container {
    background: linear-gradient(90deg,rgb(107, 164, 229) 0%, rgb(87, 204, 181) 100%) rgba(74, 156, 140, 0.95);
    color: white;
    padding: 5rem 0;
